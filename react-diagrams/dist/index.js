...
var react_diagrams_routing_1 = require("@projectstorm/react-diagrams-routing");
var react_canvas_core_1 = require("@projectstorm/react-canvas-core");
__exportStar(require("@projectstorm/react-canvas-core"), exports);
...
exports.default = (function (options) {
    ...
    var engine = new react_diagrams_core_1.DiagramEngine(options);
    // register model factories
    engine.getLayerFactories().registerFactory(new react_diagrams_core_1.NodeLayerFactory());
    engine.getLayerFactories().registerFactory(new react_diagrams_core_1.NodeWLayerFactory());
